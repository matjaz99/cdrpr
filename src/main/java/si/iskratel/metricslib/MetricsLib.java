...
public class MetricsLib {
    ...
    /**
     * Enable exporting collected metrics in prometheus format on /metrics endpoint. Does not apply to MetricsLib internal metrics, they
     * are exposed anyway.
     */
...
//        context.addServlet(new ServletHolder(hs), "/");
    ...
    public static OkHttpClient instantiateHttpClient() {
        ...
        try {
            ...
            if (Start.ES_BASIC_USER != null && Start.ES_BASIC_PASS != null) {
                builder.authenticator(new Authenticator() {
                    ...
                    public Request authenticate(@Nullable Route route, @NotNull Response response) throws IOException {
                        ...
                        String credential = Credentials.basic(Start.ES_BASIC_USER, Start.ES_BASIC_PASS);
