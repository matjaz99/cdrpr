...
public class Props {
    ...
    public static boolean SIMULATOR_MOVE_FILES_WHEN_PROCESSED = false;
    ...
    public static void initialize() {
        ...
        SIMULATOR_MOVE_FILES_WHEN_PROCESSED = Boolean.parseBoolean(getenv.getOrDefault("CDRPR_MOVE_FILES_WHEN_PROCESSED", "false"));
