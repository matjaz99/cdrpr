...
public class XmlFormatter {
    ...
    private static CdrAggs.Statistics.CallStats.Counters getTrunkGroupCounters(PMultiValueMetric mv_metric) {

        for (PMultivalueTimeSeries ts : mv_metric.getMultivalueMetrics()) {

            if (ts.getValuesMap().containsKey("trunkGroup.records")) {
