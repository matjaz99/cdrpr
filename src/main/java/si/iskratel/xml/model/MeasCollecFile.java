...
public class MeasCollecFile {
    ...
    protected si.iskratel.xml.model.MeasCollecFile.FileHeader fileHeader;
    protected List<si.iskratel.xml.model.MeasCollecFile.MeasData> measData;
    @XmlElement(required = true)
    protected si.iskratel.xml.model.MeasCollecFile.FileFooter fileFooter;
